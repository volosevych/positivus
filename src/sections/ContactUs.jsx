            ...
            <Element name='Contact Us'>
                <div className="container">
                    ...
                    <div className='flex mt-20 bg-p3 rounded-3xl p-20 relative max-lg:p-5 max-lg:justify-center overflow-hidden'>
                        ...
                        <div>
                            <img src={`${process.env.PUBLIC_URL}/assets/illustrations/illustration-3.png`} className='absolute right-[-320px] top-0 max-lg:hidden' alt="contact form illustration" />
                        </div>
                    </div>
                </div>
            </Element>
