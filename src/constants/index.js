...
export const companyLogosData = [
    {
        id: '0',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/amazon.png`,
    },

    {
        id: '1',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/dribble.png`,
    },

    {
        id: '2',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/hubspot.png`,
    },

    {
        id: '3',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/netflix.png`
    },

    {
        id: '4',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/notion.png`
    },

    {
        id: '5',
        logo: `${process.env.PUBLIC_URL}/assets/companyLogos/zoom.png`
    },
];
...
export const services = [
    {
        ...
        btn: [
            {
                icon: `${process.env.PUBLIC_URL}/assets/arrows/greenArrow.svg`,
                text: 'Learn more',
            }
        ]
    },
  ...
  
    {
        ...
        btn: [
            {
                icon: `${process.env.PUBLIC_URL}/assets/arrows/blackArrow.svg`,
                text: 'Learn more',
            }
        ]
    },
  
    {
        ...
        image: `${process.env.PUBLIC_URL}/assets/services/illustration-4.png`,
        bgColor: 'bg-p3',
        bgText: 'bg-p1 rounded-md',
        btn: [
            {
...
export const team = [
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-1.svg`,
    },
  
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-2.svg`,
    },
  
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-3.svg`,
    },
  
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-4.svg`,
    },
  
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-5.svg`,
    },
  
    {
        ...
        photo: `${process.env.PUBLIC_URL}/assets/team/picture-6.svg`,
    },
  ]
